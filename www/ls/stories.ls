ig.stories =
    *   header: "1908, Londýn"
        content: 'Krasobruslení se stalo olympijským sportem šestnáct let před první zimní olympiádou, poprvé se objevilo už na letních hrách v Londýně 1908. Závodilo se víceméně v těch disciplínách, jaké známe dnes: soutěže jednotlivců a soutěž smíšených párů. Navíc se jely pouze "speciální figury mužů", kde každý závodník co nejpřesněji předvedl dvě učebnicové polohy.'
    ...
    *   header: "1932, Lake Placid"
        content: 'Na hrách v americkém Lake Placid pořadatelé pravidla některých disciplín upravili podle severoamerických zvyklostí: rychlobruslařské závody se jely s hromadným startem, na který Evropa nebyla zvyklá; na zkoušku soupeřily v rychlobruslení také ženy, v Evropě to nebylo zvykem, dominovaly proto Američanky. Na programu se objevily i závody psích spřežení, sport mimo USA a Kanadu prakticky neznámý. Část evropských sportovců hry v Lake Placid bojkotovala a na dalších hrách byla většina "amerických" změn zrušena.'
        highlight: [10 19]
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/kKcycSJzXHI" frameborder="0" allowfullscreen></iframe>'
        caption: "Archivní záběry z filmového týdeníku k Lake Placid"
        highlight: [10]
    *   header: "1936, Garmisch-Partenkirchen"
        content: "Zatímco hry v Lake Placid zahajoval budoucí prezident Roosevelt, v německém Garmisch-Partenkirchenu byl hlavní postavou říšský kancléř Adolf Hitler. Přes odpor mezinárodního olympijského výboru si prosadil závody vojenských hlídek, budoucí biatlon: z vítězství italského týmu se mohl radovat diktátor Benito Mussolini. V nově uvedeném alpském lyžování už dominovali Němci. Místo klasického curlingu pak německý výbor prosadil rakouský eisstockschießen neboli bavorský curling."
        highlight: [12 11 5]
    *   attachment: '<iframe width="390" height="300" src="//www.youtube.com/embed/jFskwtaAx6o" frameborder="0" allowfullscreen></iframe>'
    ...
    *   header: "1956, Cortina d'Ampezzo"
        content: "První zimní olympiáda, kterou vysílala televize. Při slavnostním zahájení na to doplatil italský rychlobruslař Guido Caroli, když s olympijskou pochodní zakopl o televizní kabel (na videu). Šlo zároveň o první zimní hry, jichž se zúčastnil Sovětský svaz, a rovnou je - s šestnácti medailemi, sedmi zlatými - ovládl. V hokejovém turnaji Sověti porazili Kanadu i Spojené státy a zahájili éru své dominance, která vydržela do poloviny osmdesátých let. V této a následujících dvou olympiádách startovali východní a západní Němci společně."
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/b8UTm_yxSNo" frameborder="0" allowfullscreen></iframe>'
        caption: "Amatérské záběry slavnostního zahájení s pádem rychlobruslaře, nesoucího olympijskou pochodeň"
    *   header: "1960, Squaw Valley"
        content: 'Čtyři roky před olympijskými hrami mělo kalifornské Squaw Valley jen jednoho stálého obyvatele. Ten se s vizí nového vysokohorského střediska přihlásil do boje o olympiádu - a vyhrál. Nepodařilo se mu však postavit bobovou dráhu, vládě státu Kalifornie se zdála moc drahá. Bobisté ostrouhali, jejich závod se na těchto hrách jako na jediných v historii neuskutečnil. Sovětská diplomacie vrátila na hry ženské rychlobruslení a ve třech ze čtyř disciplín sovětské sportovkyně vyhrály. Hokejový turnaj překvapivě vyhrál tým Spojených států, když Sovětský svaz dokázal porazit. Kanada poprvé protestovala proti "profesionálním amatérům" východního bloku - kvůli olympijským pravidlům byli vedení jako amatéři, ale fakticky šlo o profesionály. Mezi sporty přibyl moderní biatlon.'
        highlight: [3 21 19]
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/psS-gqxMR3s" frameborder="0" allowfullscreen></iframe>'
        caption: "Hokejový turnaj ve Squaw Valley &ndash; konec hokejového zápasu mezu USA a SSSR"
    ...
    *   header: "1968, Grenoble"
        content: "Poprvé od války startovaly samostatné týmy východního a západního Německa. Hlavním tématem her byl ale doping - rozšířil se natolik, že musely být zavedeny testy na zakázané látky. Ověřovalo se také, zda jsou všichni účastníci ženských disciplín skutečně ženy. Diskvalifikovány byly tři východoněmecké sáňkařky: z prvního, druhého a čtvrtého místa. Českoslovenští hokejisté porazili Sovětský svaz. V posledním utkání však pouze remízovali se Švédy a celý turnaj proto opět vyhráli Sověti."
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/XTmt-xGdF6Q" frameborder="0" allowfullscreen></iframe>'
        caption: "Závěr hokejového utkání Československa se Sovětským svazem"
        highlight: [15]
    *   header: "1972, Sapporo"
    ...
    *   header: "1976, Innsbruck"
        content: "Poprvé od roku 1920 se změnily krasobruslařské disciplíny - přibyly tance na ledě. Zlatou i stříbrnou medaili získaly sovětské páry. Kanada opět odmítla vyslat svůj hokejový tým, Sověti turnaj opět vyhráli. Ve finále porazili Československo 4:3. Naši hokejisti skončili druzí i přesto, že jim byly odebrány body za dopingový nález v zápase proti Polsku. Poprvé doprovodila olympiádu i zimní paralympiáda, odehrála se ve švédském Örnsköldsviku."
        highlight: [1]
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/K0sd2ZIsks8" frameborder="0" allowfullscreen></iframe>'
        caption: "V Innsbrucku se poprvé jely tance na ledě. Američtí krasobruslaři Colleen O'Connor a Jim Mills skončili třetí za dvěma sovětskými páry."
        highlight: [1]
    *   header: "1980, Lake Placid"
        content: "Na olympiádu poprvé přijeli sportovci Čínské lidové republiky. Američan Erik Heiden vyhrál všech pět rychlobruslařských disciplín, vytvořil přitom čtyři olympijské a jeden světový rekord. V hokejovém turnaji po dvaceti letech opět zvítězili Američané. Tým složený převážně z univerzitních hráčů dokázal na vrcholu studené války - jen pár měsíců po sovětské invazi do Afghánistánu - porazit favorizovaný komunistický tým 4:3. Nejvíc medailí - 23, z toho 9 zlatých - si z turnaje odvezlo východní Německo. Západní Německo jich získalo pět, zlato ani jedno."
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/NuBcvNmsVvs" frameborder="0" allowfullscreen></iframe>'
        caption: "Klíčové okamžiky hokejového zápasu Američanů se Sověty, který časopis Time označil za sportovní událost století"
        highlight: [15]
    ...
    *   attachment: "<img src='http://www.cbc.ca/sports-content/figureskating/opinion/assets_c/2011/11/620-bolero-routine-thumb-620xauto-140342.jpg' alt='' />"
        ...
        highlight: [1]
    *   header: "1988, Calgary"
        content: 'Hry v Calgary byly přelomové - nad politikou poprvé převážil důraz na komerční výsledek her. Prudce narostl počet disciplín i sportovců. Na zkoušku se objevily disicplíny "pro diváky", akrobatické lyžování a short track. Po více než padesáti letech se vrátil také curling a s ním starší sportovci. V severské kombinaci a skocích na lyžích se objevily týmové soutěže. Alpské lyžování dostalo přidáním superobřího slalomu dnešní podobu. S komerčním a diváckým rozvojem přibyli také exotičtí závodníci, výkonnostně nesrovnatelní se špičkou, například populární jamajský čtyřbob.'
        highlight: [22 7 6 5]
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/nm4DjRcmoPY" frameborder="0" allowfullscreen></iframe>'
    ...
    *   attachment: "<img src='http://blu.stb.s-msn.com/i/57/2539CFEB4B97F4C62D0DA11FEAF9C.jpg' alt='' />"
        ...
        highlight: [18]
    *   header: "2006, Turín"
        content: "Opět šlo největší a nejdražší hry v dosavadní historii; závodilo 2508 sportovců, z toho 960 žen. Znovu přibyly disciplíny, motivované diváckým zájmem: biatlon s hromadným startem, sprint dvojic v běžeckém lyžování, stíhací závod týmů v rychlobruslení a snowboardkros."
        highlight: [21 20 19]
    *   attachment: '<iframe width="390" height="293" src="//www.youtube.com/embed/XRckah4i8kM" frameborder="0" allowfullscreen></iframe>'
        caption: 'V Turíně přibyl stíhací závod týmů v rychlobruslení'
        highlight: [19]
